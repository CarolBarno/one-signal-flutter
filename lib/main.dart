  ...
  Future<void> initPlatformState() async {
    ...
    OneSignal.shared.setNotificationReceivedHandler((OSNotification notification) {
      this.setState(() {
        ...
        print('Title is >>> ${notification.payload.title}');
        print('Body is >>> ${notification.payload.body}');

        print('Data is >>> ${notification.payload.additionalData}');
      });
    });
    ...
    await OneSignal.shared
        .init("2d34b198-fde4-4722-b4e8-e5dcf43a6248", iOSSettings: settings);
